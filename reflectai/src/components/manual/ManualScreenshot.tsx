      ...
      <div className="relative w-full overflow-hidden rounded-2xl border border-white/50 bg-white/30 backdrop-blur-md shadow-lg shadow-purple-200/30">
        <div className="relative w-full aspect-[16/9]">
          {!hasError ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-gradient-to-br from-white/40 to-white/10 text-center px-6">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-white/60 border border-white/70 shadow">
                <CameraIcon className="w-6 h-6 text-slate-600" />
              </div>
              <div className="space-y-1">
                <p className="text-sm font-semibold text-slate-700">Captura pendiente</p>
                <p className="text-xs text-slate-500">
                  Se agregará esta imagen cuando la interfaz esté finalizada.
                </p>
              </div>
            </div>
          )}
