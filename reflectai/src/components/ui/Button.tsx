...
export default function Button({
  ...
  const baseStyles =
    'flex items-center justify-center rounded-2xl font-semibold transition-transform active:scale-95';

  const variants = {
    default:
      'bg-gradient-to-r from-orange-300 to-orange-400 text-white shadow-lg shadow-orange-400/30 hover:scale-[1.02]',
