      ...
      <GlassCard className="flex min-h-[90vh] flex-col gap-10 p-6 pb-32">
        ...
        <section className="space-y-4">
          <div className="flex items-start gap-3 rounded-2xl border border-amber-200/70 bg-amber-50/60 p-4 text-amber-950 shadow-sm">
            <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-xl border border-amber-200/70 bg-white/70">
              <WarningIcon className="h-5 w-5" />
            </div>
            <div className="space-y-1">
              <p className="text-sm font-bold">Important notice</p>
              <p className="text-sm leading-relaxed">
                ReflectAI supports self-awareness and reflection. <span className="font-semibold">It is not a clinical tool</span>{' '}
        ...
        <section className="space-y-6">
          <h2 className="text-sm font-bold uppercase tracking-tighter text-slate-900/40 dark:text-black/40">
          ...
          <ManualStep
            ...
            description={
              <>
                On the main screen, select <span className="font-semibold">Register</span>.
          ...
          <ManualStep
            ...
            description={
              <>
                If you forget your password, select <span className="font-semibold">Forgot your password?</span>.
        ...
        <section className="space-y-6">
          <h2 className="text-sm font-bold uppercase tracking-tighter text-slate-900/40 dark:text-dark/40">
          ...
          <ManualStep
            ...
            description={
              <>
                From the dashboard, select <span className="font-semibold">New reflection</span>.
          ...
          <ManualStep
            ...
            description={
              <>
                Some questions include a <span className="font-semibold">1 to 10</span> scale.
          ...
          <ManualStep
            ...
            description={
              <>
                When you reach the end, select <span className="font-semibold">Save session</span>.
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <details className="group rounded-2xl border border-white/50 bg-white/25 p-4 shadow-sm backdrop-blur-md">
              <summary className="flex cursor-pointer list-none items-center justify-between font-semibold text-slate-900 dark:text-black">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                Yes. Open the session from your history and use the <span className="font-semibold">Delete</span> button at the bottom.
              </p>
            </details>
            ...
            <details className="group rounded-2xl border border-white/50 bg-white/25 p-4 shadow-sm backdrop-blur-md">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                Yes. Open <span className="font-semibold">Account settings</span> and choose <span className="font-semibold">Delete account</span>.
