...
describe('validaciones de endpoints de IA', () => {
  it('acepta solicitudes válidas para siguiente pregunta', () => {
  ...
  it('rechaza sessionId inválido y demasiadas preguntas', () => {
    const result = nextQuestionSchema.safeParse({
  ...
  it('acepta solicitudes válidas para analizar sesión', () => {
